...
def subject_process(dir_path, subject_ID):
  class_path = os.path.join(dir_path, subject_ID)
...
if __name__=="__main__":
  dir_path = sys.argv[1]
  for subject_ID in os.listdir(dir_path):
    subject_process(dir_path, subject_ID)
